...
$$
F^{*} = \frac{(SSE_{S}-SSE_{L})/(df_{S}-df_{L})}{\frac{SSE_{L}}{df_{L}}} \sim F_{df_{S}-df_{L},\ df_{L}} \\
df_{S}=n-p_{S}-1,\ df_{L}=n-p_{L}-1
$$

$$
\begin{aligned}
&F^{*}>F_{1-\alpha,\ df_{S}-df_{L},\ df_{L}},\ reject\ H_{0}\\
&F^{*}\leq F_{1-\alpha,\ df_{S}-df_{L},\ df_{L}},\ fail\ to\ reject\ H_{0}
\end{aligned}
$$
$$
\begin{aligned}
&F^{*}=34.694\\
&F_{1-\alpha,\ df_{S}-df_{L},\ df_{L}}=F_{0.95,\ 1,\ 3}=10.12796\\
&F^{*}>F_{0.95,\ 1,\ 3},\ reject\ H_{0}
\end{aligned}
$$
...
$$
\begin{aligned}
&Model\ 1:\ Y_{i}=\beta_{0} \ +\ \beta_{1}X_{i\ ERvisits} \ +\ \beta_{2}X_{i\ comp\_bin} \ +\ \varepsilon_{i}\\
...
\begin{aligned}
&F^{*}=44.49\\
&F_{1-\alpha,\ df_{S}-df_{L},\ df_{L}}=F_{0.95,\ 2,\ 5}\\
&F^{*}>F_{0.95,\ 2,\ 5},\ reject\ H_{0}
\end{aligned}
$$
...
\begin{aligned}
&F^{*}=3.5997\\
&F_{1-\alpha,\ df_{S}-df_{L},\ df_{L}}=F_{0.95,\ 1,\ 4}=7.708647\\
&F*<F_{0.95,\ 1,\ 4},\ fail\ to\ reject\ H_{0}
\end{aligned}
$$
