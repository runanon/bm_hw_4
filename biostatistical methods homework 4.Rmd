...
$$
\hat{Y} = 1.53X_{comp\_bin} \ +\ 0.17X_{ERvisits} \ +\ 0.005X_{duration} \ +\ 4.76
$$

### ii) 
Compare the SLR and MLR models. Which model would you use to address the investigator’s objective and why? (2p)

Due to the fact that the investigator is mainly interested if there is an association between ‘total cost’ and the ‘number of emergency room (ER) visits’, I choose SLR. SLR is more intuitive and simple to explain.
